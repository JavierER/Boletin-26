 ...
 * @author Javii
 */
public class Ventana1Bono extends javax.swing.JFrame {

    /**
     * Creates new form Ventana1Bono
     */
    public Ventana1Bono() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton64.setBackground(new java.awt.Color(255, 255, 51));
        jButton64.setText("SUERTE!");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                    ...
                    .addComponent(jButton64, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(23, 23, 23)))
        );
    ...
    private void jButton63ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton63ActionPerformed
       Aleatorios(jButton63);   
       for(int i=0;i<Random.size();i++){
       jTextField2.setText(jTextField2.getText()+"  "+Random.get(i));
       
       }
    }//GEN-LAST:event_jButton63ActionPerformed

    private void jButton64ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton64ActionPerformed
        ganaryperder(jButton64);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana1Bono.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana1Bono().setVisible(true);
            }
        });
    }
...
public void Aleatorios(JButton jButton63){
    int numeros;
    for(int i = 0;i<6;i++){
            numeros = (int) Math.floor(Math.random()*49)+1;
            while(Random.contains(numeros)){
            numeros = (int) Math.floor(Math.random()*49)+1;
            }
            Random.add(numeros);
        }
}
public void ganaryperder(JButton jButton64){
    if (Numeros.equals(Random)){
